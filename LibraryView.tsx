  ...
  return (
    <div className="flex-1 overflow-y-auto bg-gradient-to-b from-[#2a1a4e] via-[#121212] to-[#121212] p-6">
      <div className="max-w-5xl mx-auto">
        ...
        {filtered.length > 0 ? (
          <div>
            <div className="grid grid-cols-[2rem_1fr_1fr_3rem_4rem_2rem] gap-4 px-4 py-2 border-b border-[#282828] text-[#b3b3b3] text-xs uppercase tracking-wider font-medium mb-2">
              <span>#</span>
              <span>Título</span>
              <span>Artista</span>
            ...
            {filtered.map((track, idx) => {
              ...
              return (
                <div
                  key={track.id}
                  className={`grid grid-cols-[2rem_1fr_1fr_3rem_4rem_2rem] gap-4 px-4 py-3 items-center group cursor-pointer rounded-md transition-colors ${
                ...
                >
                  ...
                  <div className="flex justify-center">
                    <button
                      ...
                      className={`transition-colors ${track.liked ? 'text-[#1DB954]' : 'text-[#b3b3b3] opacity-0 group-hover:opacity-100 hover:text-white'}`}
                    >
                      <svg viewBox="0 0 24 24" fill={track.liked ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="1.5" className="w-4 h-4">
                  ...
                  <button
                    ...
                    className="text-[#b3b3b3] hover:text-red-400 transition-colors opacity-0 group-hover:opacity-100"
                  >
