...
export const UploadView: React.FC = () => {
  const { addTracks, tracks, removeTrack, playTrack, currentTrack, storageReady } = usePlayer();
      ...
      <div className="max-w-5xl mx-auto">
        {!storageReady ? (
          <div className="flex flex-col items-center justify-center py-24 gap-4">
            <svg className="animate-spin w-8 h-8 text-[#1DB954]" fill="none" viewBox="0 0 24 24">
              <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" />
              <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z" />
            </svg>
            <p className="text-[#b3b3b3] text-sm">Cargando tu biblioteca...</p>
          </div>
        ) : (
          <>
